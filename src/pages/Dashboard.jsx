          ...
          return (
            <div className="bg-green-900/10 border border-green-700/20 rounded-2xl p-3 text-center">
              <p className="text-green-400 text-sm">
                ...
                {typeof existingJustification.sessionsJustified === 'number'
                  ? ` (${existingJustification.sessionsJustified} sesión${existingJustification.sessionsJustified === 1 ? '' : 'es'})`
                  : ''}
                {' — '}
                {typeof existingJustification.sessionsJustified === 'number' &&
                 existingJustification.sessionsJustified < (myStatus.totalRequired - myStatus.sessions)
                  ? `aún te falta${myStatus.totalRequired - myStatus.sessions - existingJustification.sessionsJustified === 1 ? '' : 'n'} ${myStatus.totalRequired - myStatus.sessions - existingJustification.sessionsJustified} para evitar la multa`
                  : 'sin multa esta semana'}
              </p>
